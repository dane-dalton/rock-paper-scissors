...
promptBox.textContent = 'Welcome! Play in a Best of 5 Series of Rock, Paper, Scissors against our finest robot on the market!'
...
function endGame() {
    if ( parseInt(userCounter.textContent) >= 5 ||  parseInt(cpuCounter.textContent) >= 5 ) {
        ...
        playAgainNoBtn.addEventListener('click', () => {
            ...
            promptBox.textContent = 'Thank you for playing! Come back any time you like!'
